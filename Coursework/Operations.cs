...
namespace Coursework
{
	...
	public partial class Operations : Form
	{
		...
		/// Вызывает метод, открывающий файлы, проверяющий их корректность
		/// и визуализирующий полученные данные.
		/// </summary>
		...
		/// <summary>
		/// Метод для открытия файлов наблюдений с проверкой длины
		/// и корректности данных, обновляет информацию в логгере, 
		/// в случае правильности данных меняет флаг наличия файлов
		/// наблюдений, активизирует связанные с этим кнопки, вызывает
		/// матлаб функцию визуализации данных.
		/// </summary>
		async void AddData()
		{
		...
		/// <summary>
		/// Метод для открытия файлов матрицы с проверкой длины
		/// и корректности данных, обновляет информацию в логгере, 
		/// в случае правильности данных меняет флаг наличия файлов
		/// матрицы, активизирует связанные с этим кнопки, вызывает
		/// матлаб функцию визуализации данных.
		/// </summary>
		...
		/// Вызывает метод, открывающий файл, проверяющий его корректность
		/// и визуализирующий полученные данные.
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		...
		/// <summary>
		/// Метод для открытия файлов статистики с проверкой длины
		/// и корректности данных, обновляет информацию в логгере, 
		/// в случае правильности данных меняет флаг наличия файлов
		/// статистики, активизирует связанные с этим кнопки, вызывает
		/// матлаб функцию визуализации данных, запоминает наибольшее
		/// и наименьшее значение сигнала для настройки слайдера.
		/// </summary>
		async void AddStat()
		{
		...
		/// Вызывает асинхронный метод генерации и визуализации наблюдений.
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		...
		/// <summary>
		/// Метод для генерирования и визуализации наблюдений,
		/// настраивает вид формы на время осуществления 
		/// процесса и вызывает метод генерирования и визуализации
		/// наблюдений из экемпляра класса
		...
		/// Вызывает асинхронный метод расчета и визуализации корреляционной матрицы.
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		...
		/// <summary>
		/// Метод для расчета и визуализации корреляционной матрицы,
		/// настраивает вид формы на время осуществления процесса и вызывает
		/// метод расчета и визуализации матрицы из класса библиотеки, засекает
		...
		/// Вызывает асинхронный метод расчета и визуализации статистики.
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		...
		/// <summary>
		/// Метод для расчета статистики и визуализации наблюдений,
		/// настраивает вид формы на время осуществления процесса
		/// и вызывает метод расчета и визуализации статистики 
		/// наблюдений из экемпляра класса
		/// функций матлаб, засекает время за которое процесс
		/// завершается, обновляет информацию в логгере и флаг
		/// наличия статистики наблюдений в случае успеха, также
		/// запоминает минимальное и максимальное значения сигнала из
		/// статистики для дальнейшего отображения на слайдере.
		/// </summary>
		async void BeginL()
		{
			try
			{
				...
				statE = sliderH.Enabled = min.Visible = max.Visible = label1.Visible = true;
			}
			catch (Exception e)
			{
		...
		/// <summary>
		/// Метод для визуализации данных статистики при изменении
		/// порогового значения сигнала, настраивает
