...
load C:\Users\Natalya\Desktop\Coursework\Coursework\bin\Debug\Rx.txt;
load C:\Users\Natalya\Desktop\Coursework\Coursework\bin\Debug\Ry.txt;
...
L(:,:,i,k,l)=mu*L(:,:,i,k,l)./(1-L(:,:,i,k,l)); % ÔÎÐÌÈÐÎÂÀÍÈÅ ÒÐÅÁÓÅÌÎÉ ÑÒÀÒÈÑÒÈÊÈ
...
Lfile=L(:,:);
save C:\Users\Natalya\Desktop\Coursework\Coursework\bin\Debug\Lfile.txt Lfile -ascii;
