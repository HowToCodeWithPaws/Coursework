...
VisFiles(1, N,Um,Vm,Nu, Nv, Ns, lu, lv, lt, ii,kk,ll,real(U),0, 'Вещественные составляющие пробных сигналов по углам', [0 0 300 200]);
VisFiles(1, N,Um,Vm,Nu, Nv, Ns, lu, lv, lt, ii,kk,ll,imag(U),0, 'Комплексные составляющие пробных сигналов по углам', [290 0 300 200]);
...
VisFiles(1, N,Um,Vm,Nu, Nv, Ns, lu, lv, lt, ii,kk,ll,S,0, 'Пробные сигналы по времени', [580 0 300 200]);
